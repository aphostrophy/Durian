...
static const char *task_time_stats_map_file_path = "/sys/fs/bpf/oberon/task_time_stats";
static const char *task_time_stats_graveyard_map_file_path = "/sys/fs/bpf/oberon/task_time_stats_graveyard";
...
int main(int argc, char **argv)
{
    ...
    err = link_oberon_tracepoint_probe("oberon_probes/sched/sched_process_exit.o");
    if (err)
    {
        printf("The kernel didn't load the BPF program: %s\n", strerror(errno));
    }
